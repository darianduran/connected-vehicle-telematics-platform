# 6.0 Capacity & Performance Planning

## 6.1 Load Assumptions and Traffic Model
...
| Events per vehicle | ~1 event/15 sec (active) | Technical design (4.1.1) |
...
| Average event size | ~1 KB | Technical design (4.1.2) |
...
### 6.3.1 Telemetry Ingestion (Kinesis)
...
### 6.3.3 Compute - Telemetry Consumer Service
...
### 6.3.4 Compute - SSE Streaming Service
...
---
[Security Framework](05-security-framework.md) | [Next: Resilience & Disaster Recovery](07-resilience-and-disaster-recovery.md)