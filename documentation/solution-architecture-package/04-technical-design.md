...
## 4.1 Telemetry Ingestion Pipeline
...
### 4.1.4 Telemetry Consumer Service (ECS Fargate)
...
### 4.2.2 Organization-Scoped Tables
...
### 4.2.5 Tenant Isolation Enforcement
...
## 4.3 Trip Processing Pipeline

### 4.3.1 Trip Detection State Machine
...
### 4.3.2 S3 Breadcrumb Archive Format
...
### 4.3.4 Incident & Emergency Alert Delivery
...
### 4.5.1 Edge-Side Clip Retrieval
...
## 4.6 Component Designs

### 4.6.1 OEM Command Proxy
...
### 4.6.2 Real-Time Streaming Service
...
### 4.6.3 Predictive Maintenance Analytics
...
---
[Solution Architecture](03-solution-architecture.md) | [Next: Security Framework](05-security-framework.md)